...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.cors(Customizer.withDefaults())
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/login", "/register", "/send-reset-otp","/send-otp","/verify-otp", "/reset-password", "/logout", "/admin/login")
                        .permitAll()
                                ...
                                .requestMatchers(HttpMethod.POST,"/hirueats/orders").hasRole("USER")
                                .requestMatchers(HttpMethod.GET,"/hirueats/orders/user/**").hasRole("USER")
                                .requestMatchers(HttpMethod.GET,"/hirueats/orders").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT,"/hirueats/orders/**").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.POST, "/hirueats/feedback").hasRole("USER")
                                .requestMatchers(HttpMethod.GET, "/hirueats/feedback").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.GET, "/hirueats/feedback/**").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.PUT, "/hirueats/feedback/**").hasRole("ADMIN")
                                .requestMatchers(HttpMethod.DELETE, "/hirueats/feedback/**").hasRole("ADMIN"))
    ...
    public CorsFilter corsFilter() {
        return new CorsFilter(corsConfigurationsSource());
    }
