...
public class EmailService {
    ...
    public void sendWelcomeEmail(String toEmail, String name) {
        ...
        try {
            ...
            String htmlContent = "<!DOCTYPE html>" +
                    ...
                    "    </div>" +
                    "    <div class='content'>" +
                    "        <div class='welcome-text'>Welcome aboard, <span class='highlight'>" + name + "</span>! 👋</div>" +
    ...
    try {
        ...
        String htmlContent = "<!DOCTYPE html>" +
                ...
                "    </div>" +
                "    <div class='content'>" +
                "        <div class='reset-text'>Password Reset Request, <span class='highlight'>" + name + "</span>! 🔐</div>" +
